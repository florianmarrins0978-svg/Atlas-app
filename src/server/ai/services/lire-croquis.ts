...
- La nourrice est le regard d'où partent les réseaux (souvent un rectangle marqué « nourrice », « regard » ou « vannes »). Si elle n'est pas dessinée, rends x et y à null, et ne la place pas au point d'eau pour dépanner.
- Le piquage est l'endroit où l'arrosage se branche sur l'eau (le compteur, le robinet, souvent marqué « compteur », « piquage », « arrivée d'eau », ou un rond avec un robinet). Rends sa place en fraction du dessin, comme la nourrice ; s'il n'est pas dessiné, x et y à null, et ne le place pas à la nourrice pour dépanner.
