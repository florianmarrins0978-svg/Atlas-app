...
// le bouton — vit dans `CorpsErreur`, partagé par les dix écrans d'erreur. Lui
  ...
  return (
    <div style={{ backgroundColor: colors.cream, color: colors.ink, fontFamily: font.body, minHeight: "100%" }}>
      ...
      <div className="px-6 pt-6">
        <CorpsErreur erreur={error} reset={reset} phrase="Impossible de charger les informations pour l'instant." />
      </div>
    </div>
  );
}
