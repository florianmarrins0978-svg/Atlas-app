 ...
 * visite. « + Ajouter un client » se touche à tout moment, et la fiche se
 * replie alors sur SES prestations sans perdre une coche. La règle est dans `src/lib/passage-entretien.ts`.
 *
