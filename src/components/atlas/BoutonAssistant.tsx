 ...
 * `docs/maquettes/45-ou-mettre-l-assistant.html`, avec une précision de sa
 ...
 * pour l'éviter (`ARCHITECTURE.md` §85). Un élément qui ne flotte pas ne peut
...
export default function BoutonAssistant() {
  ...
  return (
    ...
    >
      <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth="1.8">
