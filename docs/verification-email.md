...
**Ce que l'essai du 14 septembre a montré : il faut un nom de domaine, pas
« plus tard ».** Le compte Brevo est créé, l'adresse laposte.net vérifiée, la
clé posée : Atlas a envoyé le code, Brevo l'a transmis — et la messagerie du
destinataire (iCloud) l'a refusé : *« 554 5.7.1 rejected due to laposte.net's
DMARC policy »*. Les grandes messageries gratuites interdisent qu'un tiers
envoie en leur nom. Une adresse sur un domaine à vous (une dizaine d'euros par
an, le nom n'a pas besoin d'être celui de la société) règle le point — voir
*À faire*, point 15. Rien n'est à corriger dans Atlas.
