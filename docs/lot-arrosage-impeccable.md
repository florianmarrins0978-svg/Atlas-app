...
peut réécrire**. Trois points restent à trancher par vous, en bas.
...
| L'amenée comptée pour 30 m sans un mot | le chiffre entrait dans la pression au dernier arroseur ; « 0,27 bar dans l'amenée » s'affichait comme un fait | **dit à l'écran** : « L'amenée est comptée pour 30 m : mesurez-la » — la vraie longueur reste ouverte (plus bas) | `actions.ts` |
...
- **Le piquage** vient toujours du déroulant de l'écran, pas du croquis : le
  croquis doit le porter (c'est l'avertissement au-dessus de la photo), mais
  c'est votre choix « compteur / robinet » qui commande le calcul.
