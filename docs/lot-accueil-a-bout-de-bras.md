...
| **la bande du compteur** : « En cours 3 » descend juste au-dessus du « 04 sept. » | rien | **corrigé le 6 septembre au soir, sur sa remarque.** Il était d'abord monté sur la ligne de « Vos clients » pour économiser 34 px. Puis, sur sa demande, redescendu au-dessus de la liste — mais posé AVANT les bandeaux : dans le marquage il était bien au-dessus, et un bandeau de trois cents pixels s'intercalait entre lui et la première ligne. Ma mesure ne regardait que l'ordre ; lui regardait l'écran, et il avait raison. Le compteur est maintenant DANS le fil, après les bandeaux, à 27 px de la première date quel que soit le matin |
