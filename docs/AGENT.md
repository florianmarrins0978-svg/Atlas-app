...
| Atteindre cette chaîne **depuis le planning** | fait | Ajouté le 8 août 2026, et c'est ce qui manquait vraiment : la carte d'un chantier planifié mène au chantier — donc au devis — et porte « Fin de chantier ». Elle n'ouvrait qu'un sélecteur de date, ce qui rendait toute la chaîne ci-dessus injoignable depuis l'écran où se trouve le patron (`ARCHITECTURE.md` §33) |
