...
sans la moindre erreur. Vu à la sonde uniquement (`ARCHITECTURE.md` §103).
...
panneau reste au-dessus de tout. `ARCHITECTURE.md` §103.
...
`docs/maquettes/46-ou-mettre-l-assistant.html`, sa lettre est attendue.
