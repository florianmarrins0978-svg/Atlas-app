...
export const RAPPEL = [
  ...
  "",
  "**Et ce que la correction laisse derrière compte autant** : ce qui ne sert",
  "plus se SUPPRIME (§4 quinquies, `test-pas-de-code-mort.ts`), et le lien",
  "descend au lieu de remonter d'une couche (§4 sexies, `test-couches.ts`) —",
  "`lib` ignore `server`, ni l'un ni l'autre ne connaît d'écran.",
  "",
