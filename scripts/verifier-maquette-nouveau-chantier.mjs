...
const CIBLE = resolve(
  process.argv[2] ?? join(RACINE, "docs", "maquettes", "62-le-nouveau-chantier-plus-gros.html"),
);
...
console.log("=== La maquette 62 grossit-elle sans couper ? ===\n");
...
const capture = join(RACINE, "docs", "maquettes", "images", "62-le-plus-gros.png");
...
console.log(
  plaintes.length === 0
    ? "\n=== La maquette 62 tient : plus gros, en gras, et jamais coupé. ==="
