...
· dernière migration `drizzle/0030_vocabulaire_devis_reels.sql`
...
| **Le vocabulaire du métier**, écrit une fois et envoyé avec chaque dictée — réservé à l'éditeur. Six règles de rédaction et dix-huit mots tirés de devis réels ; un quart du budget est réservé à ses corrections | `src/app/reglages/vocabulaire/` + `src/lib/consigne-metier.ts` + `drizzle/0030_vocabulaire_devis_reels.sql` |
