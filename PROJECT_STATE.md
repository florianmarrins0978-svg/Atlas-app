...
- **Les réglages, dix rubriques** — **toutes dessinées, la première est codée**
  ...
  **L'unité, elle, est codée le 14 août** : elle se choisit dans un bandeau
  ...
  écrites dans le code (`ARCHITECTURE.md` §102).
